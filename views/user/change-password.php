                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="checkout__form__input">
                                    ...
                                    <input class="mb-0" type="text" name="password_old">
                            ...
                            <div class="col-lg-12">
                                <div class="checkout__form__input">
                                    ...
                                    <input class="mb-0" type="text" name="new_password" >
                            ...
                            <div class="col-lg-12">
                                <div class="checkout__form__input">
                                    ...
                                    <input class="mb-0" type="text" name="confirm_new_password">
