...
<div class="container-fluid pt-4 px-4">
    <div class="bg-light text-center rounded p-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <h6 class="mb-0">Danh sách video</h6>
            <a href="index.php?quanli=them-video" class="btn btn-custom"><i class="fa fa-plus"></i> Thêm video</a>
        ...
        <div class="row align-items-center">
            <div class="col-lg-7 d-flex mb-3">
                ...
                <a class="link-hover" href="">Tất cả (10) </a>
                <div class="mx-2">|</div>
                <a class="link-not-hover" href="">Đã xuất bản (10) </a>
                <div class="mx-2">|</div>
                <a class="link-not-hover" href="">Thùng rác (10) </a>
            </div>
                        ...
                        <td>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu p-0">
                                    <a class="dropdown-item" href="index.php?quanli=cap-nhat-video">Xem</a>
                                    <a class="dropdown-item" href="index.php?quanli=cap-nhat-video">Sửa</a>
